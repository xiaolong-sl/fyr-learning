package com.fyr.learning.client.https.configuration;
...
public class ProfileApplication {
    ...
    public RestTemplate restTemplate() {
        try {
            ...
            keyStore.load(resourcePatternResolver.getResource("classpath:client.jks").getInputStream(), "client.jks".toCharArray());
            ...
            keyManagerFactory.init(keyStore, "client.jks".toCharArray());//通过keyStore得到密匙管理器
